...
int main() {
  suite websocket_message_reader = [] {
    ...
    "produces ping between fragments and continues data assembly"_test = [] {
      ...
      require(produced_after_ping.has_value());
      ...
      require(produced_text.has_value());
