...
namespace aero::http {
  ...
  inline std::expected<request_line, std::error_code> request_line::parse(std::string_view request_line,
    std::size_t max_method_length) {
    // RFC 9112, Section 3:
  ...
  inline std::expected<request_line, std::error_code> request_line::parse(std::span<const std::byte> buffer,
    std::size_t max_method_length) {
